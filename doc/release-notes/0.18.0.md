...
*   Removed module mod\_acl\_adminonly from core ([#1289](https://github.com/zotonic/zotonic/issues/1289)). Please use `module#mod_acl_user_groups` instead. If you need mod\_acl\_adminonly, the module is available in a [separate repository](https://github.com/zotonic/mod_acl_adminonly).
