...
*   Removed module mod\_acl\_simple\_roles from core ([#1328](https://github.com/zotonic/zotonic/issues/1328)). Please use `module#mod_acl_user_groups` instead. If you need mod\_acl\_simple\_roles, the module is available in a [separate repository](https://github.com/zotonic/mod_acl_simple_roles).
