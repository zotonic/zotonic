...
The `scomp#live` custom tag was added to `module#mod_mqtt`, allowing you to live update a part of the page on pubsub events. Documentation for `module#mod_mqtt` has been improved and a debugging option has been added so you can see which topics are published and subscribed to.
