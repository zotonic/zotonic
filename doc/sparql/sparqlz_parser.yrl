...
Nonterminals
    ...
    union_graph_pattern filter bind inline_data
    triples_same_subject property_list_not_empty property_list object_list object
    verb var_or_term var iri prefixed_name
    ...
    bracketted_expression built_in_call arg_list
...
dataset_clause -> from iri :
    {from, '$2'}.
dataset_clause -> from named iri :
    {from_named, '$3'}.
...
graph_pattern_not_triples -> filter : '$1'.
graph_pattern_not_triples -> bind : '$1'.
...
built_in_call -> iri lparen arg_list rparen :
    {call, '$1', '$3'}.
