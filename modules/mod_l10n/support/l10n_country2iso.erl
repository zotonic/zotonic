...
country2iso(<<"French Southern and Antarctic Lands">>) -> <<"tf">>;
country2iso(<<"Guadeloupe">>) -> <<"gp">>;
country2iso(<<"Guam">>) -> <<"gu">>;
country2iso(<<"Guernsey">>) -> <<"gg">>;
