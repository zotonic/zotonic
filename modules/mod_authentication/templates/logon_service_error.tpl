...
{% if error == `signup_confirm` %}
	<div class="container">
		...
		<div class="padding alert alert-error" style="display:none" id="signup_error">
			<p>
...
{% else %}
	...
	{% elseif error == `duplicate_email` %}
		<div class="container">
			<h1>{_ An account with this e-mail address already exists _}</h1>

			<p>{_ Login and go to your account page and connect Facebook or Linkedin before logging in with these. _}</p>

			<p>{_ Email address _}: <b>{{ what|escape }}</b></p>
		</div>
