...
<li id="logon_twitter">
	{% if is_connect and 'twitter'|member:identity_types %}
		...
		%}
	{% else %}
		<a href="{% url logon_service service='twitter' is_connect=is_connect %}" class="btn z-btn-social do_popupwindow" style="background-color: #55acee"><span class="z-icon z-icon-twitter"></span> {% if is_connect %}{_ Connect with Twitter _}{% else %}{_ Login with Twitter _}{% endif %}</a>
	{% endif %}
</li>
{% endif %}
{% endwith %}