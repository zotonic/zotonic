	...
	<div class="item">
		<fieldset class="admin-form">
			<div class="notification notice">
				...
				<a href="javascript:void(0)" class="do_dialog {title: '{_ Help about person name. _}', text: '{_ <strong>First</strong> also known as given name, forename or Christen name.<br/><strong>Middle</strong> often shortened to an initial like in <em>John D. Rockefeller</em>.<br/><strong>Surname prefix</strong> like the Dutch <em>van, van de, der</em>.<br/><strong>Surname</strong> also known as family name or last name. _}', width: '450px'}">{_ Need more help? _}</a>
			</div>
