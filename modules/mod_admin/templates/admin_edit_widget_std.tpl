...
<div id="{% block widget_id %}{% endblock %}" class="widget {% if in_dialog %}dialog-{% endif %}widget {% block widget_class %}{% endblock %} do_adminwidget" data-adminwidget="minifiedOnInit: {% block widget_show_minimized %}false{% endblock %}, minifier: {% if show_opened %}false{% else %}true{% endif %}">
    {% block widget_header %}
