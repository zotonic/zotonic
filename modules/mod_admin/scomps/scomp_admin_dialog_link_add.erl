...
-define(TRANS_PLUS_ADD_CONNECTION, {trans, [{en, "+ add a connection"}, {es, "+ agregar una conexión"}]}).
-define(TRANS_ADD_CONNECTION, {trans, [{en, "add a connection"}, {es, "agregar una conexión"}]}).
...
render(Params, _Vars, Context) ->
    ...
    Anchor = z_tags:render_tag(
                        ...
                        [
                    		...
                    		{<<"title">>, z_trans:trans(?TRANS_ADD_CONNECTION, Context)},
                    		{<<"class">>, "link-add"}
                    	],
                    	z_trans:trans(?TRANS_PLUS_ADD_CONNECTION, Context)),
