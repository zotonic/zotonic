...
<div class="item-wrapper">
	...
	<div class="item clearfix admin-form">
		<div class="notification notice">
			{_ Translate this page in other languages. _} <a href="javascript:void(0)" class="do_dialog" data-dialog="title: '{_ Help about translations. _}', text: '{_ The title, body and other texts can be translated in different languages. Here you can select which languages will be used. _}', width: '450px'">{_ Need more help? _}</a>
		</div>
