...
render_action(_TriggerId, TargetId, Args, Context) ->
    ...
    case proplists:get_value(appear, Args) of
        true -> {[], z_render:appear_bottom_selector(z_render:css_selector(TargetId, Args), Html, Context)};
        _ -> {[], z_render:insert_bottom_selector(z_render:css_selector(TargetId, Args), Html, Context)}
    end.
