...
tinymce.PluginManager.add('zmedia', function(editor, url) {

    var showMediaDialog = function() {
        console.log("showMediaDialog, TODO...");
    };
    
    // Add a button to the button bar
	editor.addButton('zmedia', {
		title: 'Insert Zotonic media item',
		icon: 'image',
		onclick: showMediaDialog
	});

	// Add a menu item to the tools menu
	editor.addMenuItem('zmedia', {
		icon: 'image',
