            ...
            <div class="span6">
                ...
                {% with m.modules.all as modules %}
                    {% for mod in m.modules.enabled %}
                        <div>
                            <label class="checkbox inline" for="{{ #module.mod }}"><input type="checkbox" id="{{ #module.mod }}" name="acl_mod"{% if mod|member:acl.modules %} checked="checked"{% endif %} value="{{ mod|escape }}" />{{ modules[mod]|escape }} <span class="muted">{{ mod }}</span></label>
                        </div>
                    {% endfor %}
                {% endwith %}
            </div>
                ...
                {% for mimes in [
                    ...
                    <div class="span4">
                        ...
                        {% for mime in mimes %}
                            ...
                            {% else %}
                                <li>
                                    <label class="checkbox" for="{{ #acl.mime }}">
