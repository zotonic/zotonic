...
cmd_args_jpeg_test() ->
    ...
    ?assertEqual("-background \"white\" -layers \"flatten\"   -gravity West -extent 122x80 -thumbnail 122x80\\! -gravity NorthWest -crop 80x80+21+0 -extent 80x80 +repage -colorspace \"sRGB\"   -unsharp 0.3x0.7  -quality 97", CmdArgs).
...
cmd_args_gif_test() ->
    ...
    CmdArgs = lists:flatten(z_utils:combine(32, Args)),
    ?assertEqual("-coalesce   -gravity West -extent 122x80 -thumbnail 122x80\\! -gravity NorthWest -crop 80x80+21+0 -extent 80x80 +repage -colorspace \"sRGB\"  ", CmdArgs).
