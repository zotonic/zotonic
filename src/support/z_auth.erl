...
logon(UserId, Context) ->
    case is_enabled(UserId, Context) of
        true ->
            ...
            z_context:set_session(peer, m_req:get(peer, Context2), Context2),
            UserAgent = z_convert:to_binary( z_string:trim( m_req:get(user_agent, Context2), 200) ),
            z_context:set_session(user_agent, UserAgent, Context2),
