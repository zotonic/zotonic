                ...
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="seo-description" name="seo-description" value="{{ m.seo.description|escape }}" class="form-control" />
                                <p class="help-block">
                        ...
                        <div class="form-group row">
                            <div class="col-md-8 col-md-offset-4">
                                <label class="checkbox-inline" for="seo-noindex" title="{_ Add a noindex, nofollow element to all pages. _}">
                                    <input type="checkbox" id="seo-noindex" name="seo-noindex" value="1" {% if m.seo.noindex %}checked="checked"{% endif %} />
                ...
                <div class="widget">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="seo_google-analytics" name="seo_google-analytics" value="{{ m.seo.google.analytics|escape }}" class="form-control" />
                                <p class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="seo_google-webmaster_verify" name="seo_google-webmaster_verify" value="{{ m.seo.google.webmaster_verify|escape }}" class="form-control" />
                                <p class="help-block">
                ...
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="seo_bing-webmaster_verify" name="seo_bing-webmaster_verify" value="{{ m.seo_bing.webmaster_verify|escape }}" class="form-control" />
                                <p class="help-block">
