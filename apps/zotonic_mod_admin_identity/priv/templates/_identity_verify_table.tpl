		...
		<tr>
			...
			{% if m.modules.active.mod_email_status %}
				...
				<td class="text-right">
					...
					{% else %}
						<a id="{{ #verify.idn_id }}"  href="#" class="btn btn-outline-secondary btn-sm" title="{_ Send verification e-mail _}">{_ Verify _}</a>
					...
					<a id="{{ #del.idn_id }}" href="#" class="btn btn-outline-secondary btn-sm" title="{_ Delete this e-mail address _}">{_ Delete _}</a>
					{% wire id=#del.idn_id
				...
				<td>
					<a id="{{ #status.idn_id }}" href="#" class="btn btn-outline-secondary btn-sm" title="{_ View email status _}">{_ Status _}</a>
