<div class="form-group view-expanded survey-test-checkbox">
    <div class="checkbox">
        <label>
            <input type="checkbox" value="1" name="block[].is_test" id="{{ #is_test }}" {% if blk.is_test %}checked{% endif %} />
    ...
    <div class="checkbox">
        <label class="test-controls" {% if not blk.is_test %}style="display:none"{% endif %}>
            <input type="checkbox" value="1" name="block[].is_test_direct" id="{{ #is_test_direct }}" {% if blk.is_test_direct %}checked{% endif %} />
    ...
    <div class="checkbox">
        <label class="test-controls" {% if not blk.is_test %}style="display:none"{% endif %}>
            <input type="checkbox" value="1" name="block[].is_test_neg" id="{{ #is_test_neg }}" {% if blk.is_test_neg %}checked{% endif %} />
...
<div class="form-group view-expanded test-controls" {% if not blk.is_test %}style="display:none"{% endif %}>
    ...
    <div class="controls">
        <input type="text" name="block[].test_points" id="{{ #test_points }}"
