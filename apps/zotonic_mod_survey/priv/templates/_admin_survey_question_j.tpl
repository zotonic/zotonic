<li class="page-jump" id="{{ #j }}">
    ...
    <div class="page-jump-details">
    	...
    	{_ go to _} <input name="jump-target-{{#j}}" id="jump-target-{{#j}}" class="input-small jump-target {% if nosubmit %}nosubmit{% endif %}" type="text" placeholder="{_ Question label _}" value="{{ target }}" />
