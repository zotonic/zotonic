<li class="page-jump" id="{{ #j }}">
	...
	{_ go to _} <input name="jump-target-{{#j}}" id="jump-target-{{#j}}" class="input-small jump-target {% if nosubmit %}nosubmit{% endif %}" type="text" placeholder="{_ question _}" value="{{ target }}" />
