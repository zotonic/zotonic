...
<fieldset class="form-horizontal">
    ...
    {% if not id.is_a.poll %}
        <div class="form-group row">
            <label class="control-label col-md-6">{_ When finished show _}</label>
            <div class="col-md-6">
        ...
        <div class="form-group">
            <label class="control-label col-md-6">{_ Test pass percentage _}</label>
            <div class="col-md-6">
                <input type="text" name="survey_test_percentage" id="{{ #survey_test_percentage }}"
                       class="input-small form-control" value="{{ id.survey_test_percentage }}" placeholder="" /> %
