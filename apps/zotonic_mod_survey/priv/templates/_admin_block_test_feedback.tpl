<div class="test-controls" {% if not blk.is_test %}style="display:none"{% endif %}>
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input type="text" id="block-{{name}}-test_correct{{ lang_code_for_id }}" name="block[].test_correct{{ lang_code_with_dollar }}" 
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" id="block-{{name}}-test_wrong{{ lang_code_for_id }}" name="block[].test_wrong{{ lang_code_with_dollar }}" 
