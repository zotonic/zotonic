...
{% block widget_content_nolang %}
    <div class="form-group view-expanded">
        ...
        <textarea class="form-control" id="block-{{name}}-choices" name="block[].choices" rows="4">{{ blk.choices }}</textarea>
    </div>
    ...
    <div class="form-group view-expanded question-options">
        ...
        <div class="checkbox">
            <label>
                <input type="checkbox" id="block-{{name}}-is_numeric" name="block[].is_numeric" value="1" {% if blk.is_numeric %}checked="checked"{% endif %} />
