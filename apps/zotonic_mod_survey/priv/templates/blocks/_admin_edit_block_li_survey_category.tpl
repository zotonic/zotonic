...
<div class="row view-expanded">
    <div class="col-lg-6 col-md-6 question-options">
      <div class="form-group">
          <div class="radio">
              <label>
                  <input type="radio" id="block-{{name}}-input_type" name="block[].input_type" value="" {% if not blk.input_type %}checked="checked"{% endif %} />
                  {_ Single answer possible _}
              </label>
          </div>
          <div class="radio">
              <label>
                  <input type="radio" id="block-{{name}}-input_type" name="block[].input_type" value="multi" {% if blk.input_type == 'multi' %}checked="checked"{% endif %} />
                  {_ Multiple answers possible _}
              </label>
          </div>
          <div class="radio">
              <label>
                  <input type="radio" id="block-{{name}}-input_type" name="block[].input_type" value="submit" {% if blk.input_type == 'submit' %}checked="checked"{% endif %} />
    ...
    <div class="col-lg-6 col-md-6">
        <div class="form-group">
          ...
          <select class="form-control" id="block-{{name}}-category" name="block[].category">
              <option></option>
