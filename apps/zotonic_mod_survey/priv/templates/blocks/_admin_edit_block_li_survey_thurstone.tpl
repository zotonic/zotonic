    ...
    {% if id.is_editable %}
      ...
      <div class="form-group view-expanded">
         <label class="control-label">
              {_ If you want to store <i>value</i> but show <i>answer</i>, use value#answer. E.g. <i>2019#Graduated in 2019</i> will store 2019 in the results. _}
         ...
         <textarea class="form-control" id="block-{{name}}-answers{{ lang_code_for_id }}" name="block[].answers{{ lang_code_with_dollar }}" rows="4"
...
{% block widget_content_nolang %}
    <div class="row">
        <div class="col-md-6">
            <div class="form-group view-expanded">
                <select class="form-control" id="block-{{name}}-input_type" name="block[].input_type">
