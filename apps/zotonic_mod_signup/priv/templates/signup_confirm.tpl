...
{% block content %}
    {% if q.key %}
        ...
        <p id="confirm_error" class="alert alert-warning" style="display: none">
            <span class="glyphicon glyphicon-exclamation-sign"></span> {_ You might have confirmed your account twice so that the account is already confirmed. If so, try logging in.<br>If that doesn’t work, make sure you copied the link correctly and try again. _}
        </p>
