...
{% with m.acl.use.mod_admin_config as is_editable %}
...
<div class="admin-header">
    ...
    <p>{_ You can use two-factor authentication apps such as <a rel="noopener noreferrer" target="_blank" href="https://support.google.com/accounts/answer/1066447">Google Authenticator</a>, <a rel="noopener noreferrer" target="_blank" href="https://duo.com/product/trusted-users/two-factor-authentication/duo-mobile">Duo Mobile</a> or <a rel="noopener noreferrer" target="_blank" href="https://1password.com">1Password</a>. _}</p>
</div>
