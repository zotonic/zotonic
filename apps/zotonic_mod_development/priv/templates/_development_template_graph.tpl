...
<p class="help-block">
    {_ Dependency graph of all templates. Only template includes using an immediate string value for the template name are shown. _}<br>
    {_ Template includes using variable names or expressions for the template name are not shown. _}<br>
