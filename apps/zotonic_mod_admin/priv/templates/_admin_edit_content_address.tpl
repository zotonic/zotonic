...
{% block widget_content %}
	...
	{% block address %}
	    <div class="form-group">
	    	<div class="widget-section-header">
	    		{% block address_title %}{_ Visiting address _} {_ (private) _}{% endblock %}
	    	</div>
	    </div>
	...
	{% block mail_address %}
	    <div class="form-group">
	    	<div class="widget-section-header">
	    		{% block mail_address_title %}{_ Mailing address _} {_ (public) _}{% endblock %}
	    	</div>
	    </div>
	...
	{% block billing_address %}
		{% if id.is_editable %}
		    <div class="form-group">
		    	<div class="widget-section-header">
		    		{% block billing_address_title %}{_ Billing address _} {_ (private) _}{% endblock %}
		    	</div>
		    </div>
