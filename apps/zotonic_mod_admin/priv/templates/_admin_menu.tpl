        ...
        <div class="navbar-collapse collapse" id="admin_menu_collapse">
            ...
            {% block search %}
                <form class="navbar-right navbar-form form-inline" action="{% block search_target %}{% url admin_overview_rsc %}{% endblock %}" method="get">
                    ...
                    <input autocomplete="off" class="search-query form-control" type="text" name="qs" value="{{q.qs|escape}}" placeholder="{% block search_placeholder %}{_ Search... _}{% endblock %}" data-search-view="true" />
                </form>
            {% endblock %}
