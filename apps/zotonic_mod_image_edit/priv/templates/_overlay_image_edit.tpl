...
<div class="image-edit {% if modal %}-modal{% endif %}">
        ...
        <div id="image-edit-settings" class="image-edit__settings">
            {% if modal %}
                {% wire id="image-edit-form"
                        type="submit"
                        postback={edit_form id=id on_success={dialog_close}}
            ...
            <form id="image-edit-form" action="postback">
                ...
                <div class="form-actions">
                    ...
                    {% if modal %}
                        {% wire id="image-edit-cancel" action={dialog_close} %}
                    {% else %}
...
{% javascript %}
    function image_edit_apply_css() {
        ...
        let h = $(".image-edit__original").height();
