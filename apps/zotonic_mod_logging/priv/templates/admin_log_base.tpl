...
<ul class="nav nav-tabs">
    ...
    <li class="{% block active3 %}{% endblock %}"><a href="{% url admin_log_csp %}">{_ Content-Security log _}</a></li>
    <li class="{% block active4 %}{% endblock %}"><a href="{% url admin_log_ui %}">{_ User interface log _}</a></li>
</ul>
