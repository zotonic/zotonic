    ...
    tinymce.create("tinymce.plugins.ZotonicMediaPlugin", {
        init : function (ed, url) {
            ...
            ed.on("click", function (o) {
                if (o.target.nodeName === "IMG") {
                    ed.execCommand("mceZotonicMedia", o.target);
                }
            });
        ...
        _openPropertiesDialog: function (node) {
            ...
            $("body").on('submit', "#zmedia-props-form", function (ev) {
                ...
                new_opts = {
                        ...
                        "crop": $("#zmedia-props-form input[name='crop']:checked").val() ? "1" : "",
                        "link": $("#zmedia-props-form input[name='link']:checked").val() ? "1" : "",
