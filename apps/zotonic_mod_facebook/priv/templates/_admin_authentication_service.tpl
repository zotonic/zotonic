        ...
        <div class="col-md-6">
            <div class="widget">
                ...
                <div class="widget-content">
                    <p class="help-block">
                        {_ Application keys can be found in _} <a href="https://developers.facebook.com/apps/" title="Developer Dashboard" target="_blank" rel="noopener noreferrer">{_ Your Facebook Developer Dashboard _}</a>
                    </p>
