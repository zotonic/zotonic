...
-export([observe_seo_sitemap_index/2,
...
observe_seo_sitemap_urlset(#seo_sitemap_urlset{
                               source = <<"seo_sitemap">>,
                               offset = Offset,
                               limit = Limit
                           },
...
event(#postback{ message = sitemap_rebuild }, Context) ->
    case z_acl:is_admin(Context) orelse z_acl:is_allowed(use, mod_seo_sitemap, Context) of
        true ->
