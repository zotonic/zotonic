...
mod_seo_sitemap creates a `sitemap.xml` file for which is used by the Google bot to index your site. By default, its
...
You will be able to write your own sitemap.xml file (in a mysitemap.tpl template) without using mod_seo_sitemap.
