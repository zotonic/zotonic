...
Same as [default_if_undefined](/id/doc/template_filter_filter_default_if_undefined).
...
%% inlines when compiling templates. Same as filter_default_if_undefined.
default_if_none(undefined, Default, _Context) -> Default;
default_if_none(V, _Default, _Context) -> V.
