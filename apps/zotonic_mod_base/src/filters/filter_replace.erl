...
::: note
This filter is inefficient, as it will compile and match a regular expression while serving the template. Try to do string replacements when you save your content, and not when you serve the content.
:::
").
-export([
    replace/3,
