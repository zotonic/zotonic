...
-module(action_wires_fade_in).
-moduledoc("
See also

actions [toggle](/id/doc_template_action_action_toggle), [show](/id/doc_template_action_action_show),
[hide](/id/doc_template_action_action_hide), [fade\\_out](/id/doc_template_action_action_fade_out),
...
render_action(TriggerId, TargetId, Args, Context) ->
	action_wires_jquery_effect:render_action(TriggerId, TargetId, [{type,fade_in}|Args], Context).
