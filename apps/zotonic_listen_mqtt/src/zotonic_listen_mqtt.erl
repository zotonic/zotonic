...
start_mqtt_listeners_ip4(WebIp, WebPort) ->
    ...
    case ranch:start_listener(zotonic_mqtt_listener_ipv4,
                              ranch_tcp,
                              #{
...
start_mqtts_listeners_ip4(none, _SSLPort) ->
    ignore;
...
start_mqtts_listeners_ip4(WebIp, SSLPort) ->
    ...
    case ranch:start_listener(zotonic_mqtts_listener_ipv4,
                              ranch_ssl,
                              #{
...
start_mqtt_listeners_ip6(none, _WebPort) ->
    ignore;
start_mqtt_listeners_ip6(_WebIp, none) ->
    ignore;
start_mqtt_listeners_ip6(WebIp, WebPort) ->
    ...
    {ok, _} =
        ranch:start_listener(zotonic_mqtt_listener_ipv6,
                             ranch_tcp,
                             #{
                                 num_acceptors => z_config:get(inet_acceptor_pool_size),
                                 max_connections => z_config:get(mqtt_max_connections),
...
start_mqtts_listeners_ip6(none, _SSLPort) ->
    ignore;
start_mqtts_listeners_ip6(_WebIp, none) ->
    ignore;
start_mqtts_listeners_ip6(WebIp, SSLPort) ->
    ...
    {ok, _} =
        ranch:start_listener(zotonic_mqtts_listener_ipv6,
                             ranch_ssl,
                             #{
                                 num_acceptors => z_config:get(ssl_acceptor_pool_size),
                                 max_connections => z_config:get(mqtt_ssl_max_connections),
