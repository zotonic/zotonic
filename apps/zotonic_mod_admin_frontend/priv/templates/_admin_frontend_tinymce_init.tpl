...
{% javascript %}
	window.tinyInit = {
		mode: "none",
		theme: "advanced",
		theme_advanced_buttons1: "bold,italic,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,|,link,unlink,|,cleanup,codemagic,|,formatselect,|,zlink,zmedia,|,ltr,rtl,zbdoltr,zbdortl",
...
{% javascript %}
	window.tinyInit = {
		...
		mode: "none",
		theme: "modern",
		plugins: "compat3x advlist codemirror paste table link zlink zmedia autosave directionality autoresize lists",
