...
{% block content %}
    ...
    <div class="admin-header">
        <h2>{_ Import a CSV or XLSX file _}</h2>
    </div>

    {% if m.acl.is_allowed.use.mod_import_csv %}
        <div class="widget">
            <div class="widget-content">
                ...
                <table class="table table-compact table-striped" style="width: auto">
                    ...
                    <tr>
                        ...
                        <td>{_ The unique name of the page, used to identify the page. _}</td>
                    </tr>
                    <tr>
    ...
    {% else %}
        <div class="alert alert-danger">
            {_ You do not have permission to use the CSV/XLSX import module. _}
        </div>
    {% endif %}
