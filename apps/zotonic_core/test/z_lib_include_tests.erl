...
uncollapse_test() ->
    ?assertEqual([], z_lib_include:uncollapse("")),

    ?assertEqual([<<"/a/b1.js">>, <<"/a/b2.js">>, <<"/a/b/c.js">>, <<"/a/b3.js">>],
                 z_lib_include:uncollapse(<<"/a/b1~b2~b/c~/a/b3~63415422477.js">>)),
    ?assertEqual([<<"/a/b1.js">>], z_lib_include:uncollapse(<<"/a/b1~63415422477.js">>)),
    ?assertEqual([<<"/a1.js">>, <<"/a2.js">>], z_lib_include:uncollapse(<<"/a1~a2~63415422477.js">>)),
    ok.

tag_test() ->
    C = z_context:new(zotonic_site_testsandbox),
    ?assertEqual([_LinkElem = [], _ScriptElem = []], z_lib_include:tag([], C)),
    ?assertEqual([_LinkElem = [], _ScriptElem = []], z_lib_include:tag([<<"/images/test.jpg">>], C)).
