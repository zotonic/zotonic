...
language_test() ->
    ...
    Props =
        #{
            ...
            <<"is_published">> => true,
            <<"language">> => ['zh-hant', en],
            <<"title">> => #trans{ tr = [{en, <<"Hello">>}, {'zh-hant', <<"香港"/utf8>>}] }
        },
