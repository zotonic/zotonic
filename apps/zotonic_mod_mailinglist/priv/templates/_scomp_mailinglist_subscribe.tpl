...
<div id="mailinglist_subscribe-{{ id }}" class="mailinglist_subscribe">
	...
	<div id="mailinglist_subscribe_form-{{ id }}">
        {% if in_admin %}
	...
	<div id="mailinglist_subscribe_done-{{ id }}" style="display:none">
		<h2>{_ Thank you _}</h2>
	 	<p>
	...
	<p id="mailinglist_subscribe_error-{{ id }}" style="display:none" class="error">
